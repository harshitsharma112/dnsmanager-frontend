...
<>
        ...
        <div className=" lg:flex text-center justify-center  font-mono" >
           ...
           <div className="lg:w-1/2  bg-cover xs:96 bg-center sl:bg-cover md:bg-cover  xs:bg-cover  bg-gray-100 h-screen w-screen   p-8 space-y-8  justify-center xs:bg-none 
            bg-no-repeat items-center"  style={{backgroundImage:`url(${dnsimage3})`}} > 
        </div>
           
            <div className="lg:w-3/5   bg-amber-200 ">
